...
const Timeline = () => {
  ...
  return (
    <Section id="about">
      ...
      During my 3-month internship, I not only demonstrated my technical skills but also became a subject matter expert in the project domain. 
      I actively collaborated with cross-functional teams, providing valuable insights and contributing to the project's success.
